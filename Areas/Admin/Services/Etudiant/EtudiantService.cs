...
public class EtudiantService : IEtudiantService
{
    ...
    public async Task<IEnumerable<Models.Etudiant>> GetAllAsync(string? searchTerm = null)
    {
    ...
    public async Task<Models.Etudiant?> GetByIdAsync(string cin)
    {
    ...
    public async Task<Models.Etudiant?> GetByMatriculeAsync(string matricule)
    {
        return await _context.Etudiants
            .AsNoTracking()
    ...
    public async Task<bool> CreateAsync(Models.Etudiant etudiant)
    {
    ...
    public async Task<bool> UpdateAsync(Models.Etudiant etudiant)
    {
    ...
    public async Task<Models.Etudiant?> GetVerifiedEtudiantForUserAsync(string? email)
    {
